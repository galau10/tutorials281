...
So far, you've been working with built-in dataframes that we give you. But soon you'll start importing and using more complicated dataframes in R. This will be a lot easier if you know a little about how your computer stores files and the idea of a "file path. This lesson provides an overview of that information.

### The Basics

Let’s start with the basics. Your computer has a *hard drive* where it stores files. To make things easier, this hard drive is organized into *folders*, which can then hold contain additional folders and *files*. These files consist of collections of data, such as text, pictures, videos, and more.

Every file on your computer has an address: this is the folder you would need to open to find the file, plus the name of the file itself. For example, you might store all your UNC files in a folder called "College. Inside that, you might have a folder called "Fall 2023 classes", and inside that, you might have a folder called "POLI 281", and inside that, you might have a file called "congressdata.csv". We can think of this information as defining a unique path to that file. It's like giving R directions on where to find the data you want to work with!

Every file on your computer has an address: this is the folder you would need to open to find the file, plus the name of the file itself. For example, you might store all your UNC files in a folder called "College. Inside that, you might have a folder called "Fall 2023 classes", and inside that, you might have a folder called "POLI 281", and inside that, you might have a file called "congressdata.csv". We can think of this information as defining a unique path to that file. It's like giving R directions on where to find the data you want to work with! If you want R to open the file "congressdata.csv", you have to tell it to do something like this: 

College &rarr; Fall 2023 classes &rarr; POLI 281 &rarr; congressdata.csv.

There is a standard way to list this information: it’s called a file path. File paths are slightly different depending on the type of computer you have. Let’s look at how the file paths would appear on both Windows and macOS:

- On Windows, the file path to data.csv would be `"C:/Users/YourUsername/College/Fall 2023 classes/POLI 281/congressdata.csv"`.

- On macOS, the file path to data.csv would be `"/Users/YourUsername/College/Fall 2023 classes/POLI 281/congressdata.csv`.

### Checking Your Working Directory

To get R to open a dataset, you’ll need to give it a filepath like the ones above to tell it where to find the dataset. To do this, you’ll want to set what’s called a working directory in R. The working directory is the default location where R looks for files and saves outputs. You can check the current working directory in R using the `getwd()` function:

```{r eval = F}
getwd() #check the current working directory
```

In class we will go over how to set the working directory so that you can import datasets. For now, before we move on to the next topic, take a moment to create a special folder to store all of your materials for this class. Having a dedicated POLI 281 folder will help keep your R scripts, data files, and any other class-related materials in one place, making them easier to manage and locate throughout the course!
